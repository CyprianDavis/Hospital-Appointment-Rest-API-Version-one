...
public class Appointment {
	...
	/**
	 * The set of billing records associated with this appointment. Represents the
	 * inverse side of the bidirectional relationship with {@link Billing}.
	 * 
	 * <p>
	 * Each billing record in this collection references this appointment through
	 * its {@code appointment} field, maintaining the foreign key relationship in
	 * the database.
	 * </p>
	 * 
	 * <p>
	 * This collection contains all financial charges generated from services
	 * provided during this specific appointment.
	 * </p>
	 * 
