...
public interface PatientRepository extends JpaRepository<Patient, String> {
    ...
    /**
     * Searches patients by name fields with partial matching and case insensitivity.
     * 
     * <p>Search is performed across all name fields:
     * <ul>
     ...
     * </p>
     * 
     * @param name the search term to match against patient names (case insensitive)
     * @return list of matching patients (empty if none found)
     */
    ...
    List<Patient> searchByName(@Param("nameTerm") String name);
}